				...
				<div class="column">
					...
					<div class="card">
						...
						<%Movie movie=movieList.get(i); %>
							...
							<img onclick="myFunction(this)" name="movie_id" id="<%=movie.getMovie_id()%>" src="/resources/data/<%=movie.getMovie_id()%>.<%=movie.getPoster() %>" alt="<%=movie.getMovie_name() %>" class="movie_poster" style='margin-right:10px'>
